     ...
     <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
         <div class="card">
           ...
           <div class="card-body">
                 ...
                 <form method="post" action="<?php echo base_url('master_controller/addsubcategorysuccess'); ?>" enctype="multipart/form-data" onsubmit="return valid()">
                   <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label>Sub Category Name<span style="color:red"> *</span></label>
                           <input type="text" name="name" id="name" class="form-control" placeholder="Sub Category Name" value="<?=$this -> session -> flashdata('name')?$this -> session -> flashdata('name'):''?>"/>
