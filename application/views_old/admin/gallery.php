            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
                <div class="card">
                    <div class="card-header">
                        <h4><?php echo $title; ?>
                            <a href="#" data-toggle="modal" data-target="#Viewcategory" class="btn btn-primary m-b-5 m-t-5 pull-right"><i class="fa fa-plus" aria-hidden="true"></i></a>
                        </h4>
                    </div>
                    <div class="card-body">
                             ...
                             <div class="col-lg-4 col-md-12 col-12 col-sm-12">
                                            <div class="card">
                                                <div class="img-container">
                                                    <img src="<?= base_url('uploads/gallery/'.$value -> cover_image) ?>" height="250px" alt="">
                                                    <div class="overlay text-center">
                                                        <p class="text-white"><?=$value ->details?></p>
                                                        <a href="<?=site_url('author/view-photo/'.$value -> id)?>" class="btn btn-primary"><?=$value ->name?></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>                           
