...
<div class="page-content-wrap">
    <div class="row">
        <div class="col-md-12">           
            <form method="post" class="form-horizontal" action="<?php echo base_url('master_controller/updatecategorysuccess'); ?>" enctype="multipart/form-data" onsubmit="return valid()">  
                <input type="hidden" name="updateid" id="updateid" value="<?=$CategoryList[0] -> id?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-12">                                            
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" placeholder="Category Name" value="<?=$CategoryList[0] -> name?$CategoryList[0] -> name:''?>"/>
                                </div>                                            
